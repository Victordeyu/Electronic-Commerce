// pages/alterSingle/alterSingle.js
Page({
    ...
    wx.request({
      ...
      success:function(res){
        ...
        that.setData({
          ...
          color: resData.data.color,
          cpu: resData.data.cpu,
          disk: resData.data.disk,
          inventory: resData.data.inventory,
          memory: resData.data.memory,
          price: resData.data.price,
          url: resData.data.url,
          productId:resData.data.productId,
